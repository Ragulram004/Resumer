    ...
    <div className='flex justify-center mb-6'> 
      ...
      {!image ?(
        <div className='w-20  h-20 flex items-center justify-center bg-purple-50 rounded-full relative cursor-pointer '>
          ...
          <button
            type='button'
            className='w-8 h-8 flex items-center justify-center bg-linear-to-r from-purple-50/85 to-purple-700 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer '
